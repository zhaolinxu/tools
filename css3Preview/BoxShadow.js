...
var BoxShadow={
	shadowsCount:1,
	hasRadius:function(){
		var cornerRadius=($("#demo-border-radius")[0].checked==true)?"1em":"0";
		$("#demo").css({
	...
	showShadow:function(){
		...
		$("#demo").css({
			"webkitBoxShadow":theShadow,
			"MozBoxShadow":theShadow,
			"boxShadow":theShadow
		});
		$("#code").html("-moz-box-shadow:"+theShadow+"; -webkit-box-shadow:"+theShadow+"; box-shadow:"+theShadow+";");
	},
	addShadow:function(){
		...
		$("#shadow-container"+BoxShadow.shadowsCount+" h3").html("阴影"+BoxShadow.shadowsCount);
...
$(document).ready(function(){
  $("#demo-border-radius").change(function(){
  	BoxShadow.hasRadius();
	//alert(BoxShadow.shadowCount);
  });
	BoxShadow.showShadow();
});
